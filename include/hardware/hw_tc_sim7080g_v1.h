/**
 * @file hw_tc_sim7080g_v1.h
 * @brief Hardware-configuratie: Thermocouple board met SIM7080G v1.0
 *
 * MCU: ESP32-S3-WROOM-1-N16R8 (16MB Flash, 8MB PSRAM)
 * Modem: SIM7080G (Cat-M / NB-IoT)
 *
 * Dit bestand wordt automatisch ingeladen via platformio.ini build_flags.
 * Pas ALLEEN dit bestand aan als de pinout van déze specifieke revisie wijzigt.
 */

#pragma once

// ── Board identificatie ─────────────────────────────────────────────────────
#define HW_BOARD_NAME       "Thermocouple SIM7080G v1.0"
#define HW_MCU              "ESP32-S3-WROOM-1-N16R8"

// ── LTE Modem — SIM7080G ────────────────────────────────────────────────────
#define PIN_SIM_TXD         17
#define PIN_SIM_RXD         18
#define PIN_SIM_RTS          5
#define PIN_SIM_CTS          6
#define PIN_SIM_DTR          7
#define PIN_SIM_RI           3
#define PIN_SIM_PWR         45
#define PIN_SIM_STATUS      41
#define MODEM_BAUD          115200
#define MODEM_HAS_RTS_CTS   true
